<template>
    <div class="course-purchase bg-[#f6f6f6] min-h-screen pb-20">
        ...
        <div class="bg-white">
            ...
            <div class="title p-5 text-black flex justify-between  text-xl font-bold tracking-wider">
                ...
                <view class="text-[#606369] text-xl font-bold ">￥{{ courseInfo.price }}</view>

            </div>
            <div @click="toLocation" class="px-5 pb-5 pt-0 flex justify-between">
                <span class="mr-2">
                    店铺详细地址：<span class="cuIcon-locationfill text-blue ">
                    </span>
                    广东省湛江市霞山区海滨东二路九巷一号
                </span>
                <span class="cu-btn whitespace-nowrap rounded-md    bg-green-500  text-white">
                    导航</span>
        ...
        <div class="bg-white mt-3 ">
            <div class="w-full text-black text-lg font-bold m-2 pt-4 pl-2"> 课程信息</div>
            ...
            <radio-group class="block" @change="handlePackageNo">
                ...
                <view class="cu-form-group">
                    ...
                    <view>
                        ...
                        <radio class='red ' :class="packageNo == 'A' ? 'checked' : ''"
                            :checked="packageNo == 'A' ? true : false" value="A"></radio>
                        <span class="mx-2">包月</span>

                        <radio class='red ' :class="packageNo == 'B' ? 'checked' : ''"
                            :checked="packageNo == 'B' ? true : false" value="B"></radio>
                    </view>
                </view>
            </radio-group>
            <view v-if="packageNo == 'A'" class="cu-form-group margin-top flex ">
                ...
                <radio-group class="block" @change="RadioChange">
                    <view @click="" class="cu-form-group margin-top">
                        ...
                        <radio class="red margin-left-sm" :class="pitchNumber == '10' ? 'checked' : ''"
                            :checked="pitchNumber == '10' ? true : false" value="10">
                        </radio>
                    </view>
                    <!-- #ifndef MP-ALIPAY -->
                    <view class="cu-form-group">
                        <view class="title">15节</view>
                        <radio class='red margin-left-sm' :class="pitchNumber == '15' ? 'checked' : ''"
                            :checked="pitchNumber == '15' ? true : false" value="15"></radio>
                    </view>
                    <view class="cu-form-group">
                        ...
                        <view>
                            ...
                            <radio class='red margin-left-sm' :class="pitchNumber == '25' ? 'checked' : ''"
                                :checked="pitchNumber == '25' ? true : false" value="25"></radio>
                        </view>
                    </view>
                    <!-- #endif -->
                </radio-group>
        ...
        <div class="bg-white mt-3 ">
            <div class="w-full text-black text-lg font-bold m-2 pt-4 pl-2"> 教练信息</div>

            <van-cell @click="choosecoach" title="选择教练" value="由系统指定" is-link to="home" />

            <div class="lists-item flex flex-nowrap  items-center content-center justify-between p-1 py-3">
                ...
                <div class="w-5/6 flex pl-2 flex-row items-center justify-between">
                    ...
                    <div class="btn justify-center pr-4 items-center  h-full">
                        ...
                        <span style="font-size: 30px;" class="cuIcon-roundcheckfill text-blue"></span>
        ...
        <div class="bg-white mt-3 ">
            <div class="w-full text-black text-lg font-bold m-2 pt-4 pl-2"> 个人信息</div>
        ...
        <div class="p-5 course-warning bg-white mt-3">
            ...
            <div class="warning-title font-extrabold tracking-widest text-lg "><van-icon name="warning" /> 注意事项 </div>
        ...
        <view class="cu-bar bg-white tabbar flex justify-between  shop foot">
            <view class="text-[#e4595c] text-xl font-bold px-8">￥{{ courseInfo.price }}</view>

            <view class="px-4 flex justify-end">
                <button @click="pay" class="cu-btn w-28 bg-[#ec6853] round text-white  ">立即支付</button>
            </view>
        </view>
    </div>
</template>
